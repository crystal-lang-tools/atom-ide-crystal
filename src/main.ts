...
const serverDownload = {
	darwin: {
		url:
			"https://github.com/crystal-lang-tools/scry/releases/download/v0.7.0/scry_macOS.tar.gz"
	},
	linux: {
		url:
			"https://github.com/crystal-lang-tools/scry/releases/download/v0.7.0/scry_linux.tar.gz"
	}
};
